...
import 'agora_demo_controller.dart';


class AgoraDemoView extends BaseView<AgoraDemoController>  {

  AgoraDemoView({super.key});
        ...
        displayContentBuilder: (context, isLayoutHorizontal) {
          return Stack(
            children: [
                  ...
                  child: Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        (controller.profileImage!.isEmpty) ? Padding(
                          padding: EdgeInsets.all(20),
                            child: SvgPicture.asset(Drawables.user_add,height: 30.h,width: 30.w,)) : ClipRRect(
                            borderRadius: BorderRadius.circular(22),
                            child: Image.network(controller.profileImage,fit: BoxFit.cover,height: 100.h,width: 100.w,))
                      ],
                    ),
                  ),
                )
                    : Container(
                    color: Colors.white, // Placeholder if no remote video yet
                );
              }),

              // Local video preview in a smaller container
              Obx(() => (controller.remoteUid.isNotEmpty) ? Positioned(
                top: 20,
                right: 20,
                child: SizedBox(
                  width: 100.w,
              ...
              // Display call duration if remote user is present
              Obx(() => controller.remoteUid.isNotEmpty
                  ? Align(
              ...
              // Display "Calling..." message before the call is accepted
              Obx(() => !controller.isCallRunning.value
                  ? Positioned(
                top: 100,
                left: 0,
                right: 0,
                child: Column(
                  children: [
                    ...
                    Text(
                      controller.studentName.toString(),
                      style: TextStyle(
                        color: Clr.black,
                        fontSize: 16.sp,
                        fontFamily: Fonts.PoppinsMedium,
            ...
            InkWell(
              onTap: () {
                if (controller.notificationModel == null) {
                  // controller.callActionVCallServiceTeacher('decline');
                  controller.callActionVCallServiceTeacher('misscall');
                } else {
                  controller.callActionVCallServiceTeacher('call_end');
                }
                ...
                InkWell(
                  onTap: () {
                    Get.toNamed(Routes.CHAT,parameters: {
                      ...
                      'student_name' : controller.studentName.toString(),
                    });
                  },
                  child: Container(
                    height: 40.h,
